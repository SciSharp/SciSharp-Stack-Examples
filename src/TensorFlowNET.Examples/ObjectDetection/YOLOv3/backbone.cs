    ...
    class backbone
    {
        public static (Tensor, Tensor, Tensor) darknet53(Tensor input_data)
        {
            ...
            foreach (var i in range(4))
                input_data = common.residual_block(input_data, 1024, 512, 1024, name: $"residual{i + 19}");
